...
require_once '../../model/classPedido.php';

$dado = new Pedido($con);
$dados = $dado->find($_GET['id']);
...
<div class="col-md-5">
    <form class="form-horizontal" action="../../controller/pedidos_editar.php" method="POST">
        <fieldset>
                ...
                <div class="col-sm-10">                       
                    <select name="comida">
                        <?php foreach ($dado_1 as $key => $row) : ?>
                            <option <?php if ($row->id == $dados->comida) {
                            echo 'selected';
